...
app.get('/send', function (req, res) {
    ...
    ses_mail = ses_mail + "Bom dia este é um e-mail automático de verificação de contas do www.dinneer.com."+
        "Favor não respoder o mesmo, obrigado.\n\n";
    ses_mail = ses_mail + "--NextPart\n";
    ...
    var params = {
        ...
        Source: "'AWS Tutorial Series' <" + to_email + ">'"
    };
